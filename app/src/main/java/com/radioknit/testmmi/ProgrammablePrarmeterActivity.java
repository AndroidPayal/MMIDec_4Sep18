...
import static com.radioknit.testmmi.MainActivity.count_loader_ProgrammableParameter;
import static com.radioknit.testmmi.MainActivity.isConnected;
import static com.radioknit.testmmi.MainActivity.sendMessage;
import static com.radioknit.testmmi.MainActivity.str11f1Param;
                ...
                boolean b = ha.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (counter == 0) {
                            ...
                            if(isConnected()){
                               // pd.dismiss();
                                Log.d("Tag_program", "run: count = "+count_loader_ProgrammableParameter);
                                //todo change payal
                                int timeout = 0;
                                while (true) {
